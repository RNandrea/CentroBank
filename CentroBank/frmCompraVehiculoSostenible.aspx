<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCompraVehiculoSostenible.aspx.cs" Inherits="CentroBank.frmCompraVehiculoSostenible" %>
...
<div class="contenedor3">
        ...
        <div class="col s5 l5">
            <div class="card" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/20211105112646.carros-electricos.jpg"  style="height:300px;">
                </div>
                ...
                <br>
                <lt>-Tasas fijas todo el plazo</lt>
                <p>No tenés que preocuparte por que las tasas incrementen.</p>
   ...
   <div class="col s2 l2"></div>
        <div class="col s5 l5">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/Vehiculos-Electricos.png" style="height: 300px;" >
                </div>
