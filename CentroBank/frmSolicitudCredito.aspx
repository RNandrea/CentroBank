<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSolicitudCredito.aspx.cs" Inherits="CentroBank.frmSolicitudCredito" %>
...
<div id="img1" style="height: 350px;" >
    <br>
    <br>
         <div id="contenedor4">
             <div class="row">
                 ...
                 <div class="col s12 l12">
                     ...
                     <div class="col s8 l8 ">
                         ...
                         <t1>Solicitud de crédito</t1>
                         <h5>Ingrese sus datos para realizar una solicitud de crédito.</h5>
                ...
                <div class="col s8 l8 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col s10 l10 ">
                            <h8 style="font-size: 22px;">Ingrese todos los datos solicitados</h8>
                            <br>
                            <br>
                            <br>
                        ...
                        <h8>Provincia:</h8>
                            ...
                            <h8>Dirección: </h8>
                              <div class="input-field">
                                  <div class="row">
                                      ...
                                      <div class="col s10 l10 ">
                                          <div class="input-field">
                                              <input placeholder="Dirección"  style="border-radius: 8px; border-color: grey darken-1; border-width: 2px;" id="direccion" type="text" class="validate white"> 
                                          </div>
                                      </div>
                                        ...
                                        <div class="col s10 l10 ">
                                            <div class="input-field col s12 white" style="border-radius: 8px;">
                                                <select>
                                                  ...
                                                  <option value="2">Minicrédito</option>
                                                  <option value="3">Compra Lote</option>
                                                  <option value="4">Compra Vehículos</option>
                                                  <option value="5">Compra Vivienda</option>
                                                  <option value="6">Leasing Financiera</option>
                                                  <option value="7">Préstamos Multipropósito</option>
                                                  <option value="8">Translado de Hipoteca</option>
                                                  <option value="9">Unificación de Deudas</option>
                                                  <option value="10">Compra de Vehículo Sostenible</option>
                                                </select>
                                              </div>
                                        </div>
                          ...
                          <h8>Monto a solicitar: </h8>
                          <div class="input-field">
                              <div class="row">
                                  <div class="col s1 l1 "><p></p></div>
                                  <div class="col s10 l10 ">
                                      <div class="input-field">
                                          <input placeholder="Monto"  style="border-radius: 8px; border-color: grey darken-1; border-width: 2px;" id="monto" type="number" class="validate white"> 
                                      </div>
                                  </div>
                                 
                              </div>
                        </div>
                        <h8>Fecha de solicitud: </h8>
                        <div class="input-field" >
                            <div class="row">
                                <div class="col s1 l1 "></div>
                                <div class="col s10 l10 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col s10 l10 ">
                                <label>
                                <input type="checkbox" />
                                <span>Autorizo a Centro Bank a realizar un estudio de salario.</span>
                              </label>
                            </div>
                           
                        </div>
                        <span>Su solicitud será revisada y se le notificara en un plazo de 15 días habiles.</span>
                        <div id="espacio"></div>
                            <div class="row">
                                <div class="col s4 l4 "><p></p></div>
                                <div class="col s6 l6 ">
                                    <a id="nunitobtn"  class="waves-effect waves-gray btn amber accent-2 indigo-text">Enviar Solicitud</a>
                                </div>
