<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCompraLote.aspx.cs" Inherits="CentroBank.frmCompraLote" %>
...
<div class="contenedor3">
        ...
        <div class="col s5 l5">
            <div class="card responsive-img" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/7-razones-por-las-que-comprar-un-lote-en-costa-rica-es-una-buena-idea.png"  style="height:300px;">
                </div>
   ...
   <div class="col s2 l2"></div>
        <div class="col s5 l5">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/lotes.jpg" style="height: 300px;" >
                </div>
