<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPrestamoMultiproposito.aspx.cs" Inherits="CentroBank.frmPrestamoMultiproposito" %>
...
<div class="contenedor3">
        ...
        <div class="col s5 l5">
            <div class="card responsive-img" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/multiproposito.jpg" style="height: 300px;">
                </div>
                ...
                <lt>-Flexibilidad</lt>
                <p>Rápido, simple y pensado para ayudarte con lo que necesités.</p>
                <lt>-Pagos de forma sencilla</lt>
                <p>Realízalos en nuestra Banca en Línea, desde tu computadora o celular con la aplicación móvil, además de todas las agencias disponibles en el país.</p>
   ...
   <div class="col s2 l2"></div>
        <div class="col s5 l5">
            <div class="card" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/m2.jpg" style="height: 300px;">
                </div>
                ...
                <br>
                <lt>-Moneda:</lt>
                <p>Dólares: Tasa Fija primeros 3 años de 7.15%.</p>
                <p>Colones: Tasa Fija primeros 2 años 9.5%</p>
                <lt>-Financiación mínima: </lt>
                <p>Desde los $10.000.</p>
                <lt>-Financiación máxima:  </lt>
                <p>Hasta los $100.000.</p>
                <lt>-Plazo máximo: </lt>
                <p>Hasta los 15 años.</p>
                <lt>-Seguros: </lt>
