<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMinicredito.aspx.cs" Inherits="CentroBank.frmMinicredito" %>
...
<div class="contenedor3">
        ...
        <div class="col s5 l5">
            <div class="card responsive-img">
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/minicredito.jpg" style="height: 300px;" >
                </div>
                ...
                <p>Si cumples con los requisitos de nuestra política de crédito te aprobamos el crédito de forma inmediata.</p>
                <lt>-Disponibilidad en colones</lt>
                <p>Utilizá la moneda local sin preocuparte por tipos de cambio.</p>
                <lt>-Plazos de 60 meses</lt>
                <p>Disminuye el pago de cuota al pagar a un plazo de 60 meses.</p>
   ...
   <div class="col s2 l2"></div>
        <div class="col s5 l5">
            <div class="card" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/Minicred2.jpg " style="height: 300px;">
                </div>
                ...
                <p>Colones</p>
                <lt>-Tasa: </lt>
                <p>Tasa fija anual 53%.</p>
                <lt>-Montos del crédito: </lt>
                <p>Entre 100 mil a 650 mil.</p>
                <lt>-Comisión: </lt>
                <p>Sin comisiones por desembolso y sin comisión pre pago.</p>
                <lt>-Plazo</lt>
                <p>Plazo: 60 meses.</p>
                <lt>-Seguros: </lt>
                <p>Seguros de vida y desempleo.</p>
                <br>
                
                <span style="font-family:'Nunito', sans-serif; font-size: x-large; " class=" indigo-text text-darken-2">Requisitos</span>
                <br>
                <br>
                <p>- Autorizacion CIC vigente.</p>
                <p>- Asalariado con ingresos entre 300.000 y 400.000 colones.</p>
