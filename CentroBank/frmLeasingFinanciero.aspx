<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLeasingFinanciero.aspx.cs" Inherits="CentroBank.frmLeasingFinanciero" %>
...
<div class="contenedor3">
        ...
        <div class="col s5 l5">
            <div class="card" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/20200811215130.leasing-renting.jpg"  style="height:300px;">
                </div>
               ...
               <lt>-Débito automático</lt>
                ...
                <lt>-Rápidos tiempos de respuesta</lt>
   ...
   <div class="col s2 l2"></div>
        <div class="col s5 l5">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/leasing2.jpg" style="height: 300px;" >
                </div>
                ...
                <p>Nuevo (0 kilometros), seminuevo (hasta 3 años de antigüedad).</p>
                <lt>-Moneda:</lt>
                <p>Colones y dólares</p>
                <lt>-Porcentaje de financiación máxima:</lt>
                <p>Máximo 80% del valor del vehículo</p>
                <lt>-Plazo:</lt>
                <p>Maximo de 96 meses.</p>
                <lt>-Interés:</lt>
                <p>Fijo y variable.</p>
                <lt>-Propósito:</lt>
                <p>Adquisición de vehículo./Contrato de arrendamiento y pagaré destinado a la compra de vehículos nuevos o usados.</p>
                ...
                <P>- Presentar proforma en ambos casos</P>
            </div>
            </div>
        </div>
        <div class="col s1 l1"></div>
