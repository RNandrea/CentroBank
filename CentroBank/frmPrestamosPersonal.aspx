<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPrestamosPersonal.aspx.cs" Inherits="CentroBank.frmPrestamosPersonal" %>
...
<div class="contenedor3">
        ...
        <div class="col s5 l5">
            <div class="card responsive-img" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/prestamoviajes.jpg" style="height: 300px;" >
                </div>
                ...
                <br>
                <lt>-Requisitos y trámites simples</lt>
                ...
                <lt>-Formalización gratis a domicilio</lt>
                <p>Ni siquiera tenés que moverte de la comodidad de tu casa o trabajo para finalizar los trámites.</p>
                <lt>-Sencillas formas de pago</lt>
                <p>Ponemos a tu disposición la Red de Pagos  y todas las agencias alrededor del país.</p>
                <lt>-Sin gastos extra</lt>
                <p>Eliminamos la comisión de formalización.</p>
                <lt>-Seguro de desempleo y saldo deudor</lt>
                <p>Pensamos en una solución para cualquier eventualidad que pueda suceder durante el tiempo del préstamo.</p>
            </div>
            </div>
        </div>
        <div class="col s1 l1"></div>
   ...
   <div class="col s2 l2"></div>
        <div class="col s5 l5">
            <div class="card" >
                <div class="card-image waves-effect waves-block waves-light" style="height: 300px;">
                    <img class="activator" src="/img/persona.jpg" style="height: 300px;" >
                </div>
                ...
                <p>Desde ₵250.000,00</p>
                <lt>-Financiamiento máximo:</lt>
                <p>Hasta ₵15.000.000,00</p>
                <lt>-Tipo de interés:</lt>
                <p>Variable y revisable cuatrimestralmente (meses de enero, mayo y setiembre)</p>
                
                <span style="font-family:'Nunito', sans-serif; font-size: x-large; " class=" indigo-text text-darken-2">Requisitos</span>
                <br>
                <br>
                <lt>Clientes que reciben planilla Centro Bank </lt>
                <p>- Antigüedad laboral mayor a 12 meses.</p>
                <p>- Se presta en la moneda de ingreso del cliente.</p>
                <p>- Crédito por invitación: Debe cumplir previamente con las variables de selección definidas por el Banco.</p>
                <p>- Con ingreso mayor a $500 o su equivalente en colones. </p>
                    <br>
                <lt>Asalariados </lt>
                <p>- Ingreso bruto mínimo de ₵400.000,00</p>
                ...
                <p>- Clientes clásicos deben de tener mínimo 2 años de tener las tarjetas con el Banco</p>
...
<!--fin footer--> 
    ...
    <script scr="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>s
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css">
